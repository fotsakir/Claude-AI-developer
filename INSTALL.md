...
cd /root
wget https://github.com/fotsakir/codehero/releases/latest/download/codehero-2.72.2.zip
unzip codehero-2.72.2.zip
cd codehero
...
When upgrading from 2.60.0 to 2.72.2, the system automatically runs: `2.60.4.sh` → `2.61.0.sh` → `2.61.2.sh` → `2.63.0.sh` → `2.65.0.sh`
